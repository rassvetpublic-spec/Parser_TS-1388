...
К=K, Е=E, Н=H, Х=X, В=B, А=A, Р=P, О=O, С=C, М=M, Т=T, к=K, е=E, х=X, а=A, р=P, о=O, с=C, м=M. (регистр важен!);
...
17.	SCHEMA: N3
18.	GP: GP
19.	TU: TU 4211-012-13282997-2014
20.	EXTRA: COMENT
...
Ниже приведены реальные примеры строк, соответствующих форме заказа и поддерживаемых грамматикой (после до нормализации пробелов/букв и т.п.):
...
•	№6 SENSOR: Если нашли в WorkString значения ячейки из столбца ($M$12:$M$19 на листе с именем «1»). ReplaceParam №6. NextParam. Если не нашли ошибка «Не определен НСХ». СТОП.
•	№1 TYPE: Если не нашли по шаблону "^TC[\-\s]*1388" в WorkString то TYPE=«TC-1388». WorkString=TYPE+WorkString. Ищем в WorkString шаблон "^TC[\-\s]*1388" ReplaceParam №1.
...
•	№15 HEAD: Ищем с ParamEnd(14) до ParamStart(17) «(\s*\/?-\s*\/?\s*) переводим в «—», ReplaceParam №15. NextParam. (примеры «AG-10» «ADXD»).
